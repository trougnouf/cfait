        ...
        HelpSection {
            ...
            items: vec![
                ...
                HelpItem {
                    ...
                    example: "@every 3 days, @every 2 weeks, @every mo,tue".to_string(),
                },
                HelpItem {
        ...
        HelpSection {
            ...
            items: vec![
                HelpItem {
                    ...
                    desc: "Relative to due/start (ignored if neither exists)".to_string(),
                ...
                HelpItem {
                    ...
                    example: "rem:2025-01-20 9am, rem:next friday".to_string(),
                },
            ],
        },
        HelpSection {
