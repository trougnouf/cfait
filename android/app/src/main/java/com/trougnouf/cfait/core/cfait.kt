...
external fun uniffi_cfait_fn_method_cfaitmobile_save_config(`ptr`: Long,`url`: RustBuffer.ByValue,`user`: RustBuffer.ByValue,`pass`: RustBuffer.ByValue,`insecure`: Byte,`hideCompleted`: Byte,`disabledCalendars`: RustBuffer.ByValue,`sortCutoffMonths`: RustBuffer.ByValue,`sortStandardByPriority`: Byte,`urgentDays`: Int,`urgentPrio`: Byte,`defaultPriority`: Byte,`startGracePeriodDays`: Int,`autoReminders`: Byte,`defaultReminderTime`: RustBuffer.ByValue,`snoozeShort`: Int,`createEventsForTasks`: Byte,`deleteEventsOnCompletion`: Byte,`autoRefreshInterval`: Int,`trashRetention`: Int,`maxDoneRoots`: Int,`maxDoneSubtasks`: Int,`showOngoingNotifications`: Byte,`showQuickFilter`: Byte,`quickFilterTerm`: RustBuffer.ByValue,`quickFilterIcon`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Unit
...
public interface CfaitMobileInterface {
    ...
    fun `saveConfig`(`url`: kotlin.String, `user`: kotlin.String, `pass`: kotlin.String, `insecure`: kotlin.Boolean, `hideCompleted`: kotlin.Boolean, `disabledCalendars`: List<kotlin.String>, `sortCutoffMonths`: kotlin.UInt?, `sortStandardByPriority`: kotlin.Boolean, `urgentDays`: kotlin.UInt, `urgentPrio`: kotlin.UByte, `defaultPriority`: kotlin.UByte, `startGracePeriodDays`: kotlin.UInt, `autoReminders`: kotlin.Boolean, `defaultReminderTime`: kotlin.String, `snoozeShort`: kotlin.UInt, `createEventsForTasks`: kotlin.Boolean, `deleteEventsOnCompletion`: kotlin.Boolean, `autoRefreshInterval`: kotlin.UInt, `trashRetention`: kotlin.UInt, `maxDoneRoots`: kotlin.UInt, `maxDoneSubtasks`: kotlin.UInt, `showOngoingNotifications`: kotlin.Boolean, `showQuickFilter`: kotlin.Boolean, `quickFilterTerm`: kotlin.String, `quickFilterIcon`: kotlin.String)
...
open class CfaitMobile: Disposable, AutoCloseable, CfaitMobileInterface
{
    ...
    override suspend fun `addRelatedTo`(`taskUid`: kotlin.String, `relatedUid`: kotlin.String) {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_add_related_to(
                uniffiHandle,
                FfiConverterString.lower(`taskUid`),FfiConverterString.lower(`relatedUid`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_void(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_void(future, continuation) },
    ...
    override suspend fun `addSession`(`uid`: kotlin.String, `input`: kotlin.String) {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_add_session(
                uniffiHandle,
                FfiConverterString.lower(`uid`),FfiConverterString.lower(`input`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_void(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_void(future, continuation) },
    ...
    override suspend fun `addTaskWithDescription`(`input`: kotlin.String, `description`: kotlin.String) : kotlin.String {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_add_task_with_description(
                uniffiHandle,
                FfiConverterString.lower(`input`),FfiConverterString.lower(`description`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_rust_buffer(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_rust_buffer(future, continuation) },
    ...
    override suspend fun `createLocalCalendar`(`name`: kotlin.String, `color`: kotlin.String?) : kotlin.String {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_create_local_calendar(
                uniffiHandle,
                FfiConverterString.lower(`name`),FfiConverterOptionalString.lower(`color`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_rust_buffer(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_rust_buffer(future, continuation) },
    ...
    override suspend fun `deleteSession`(`uid`: kotlin.String, `index`: kotlin.UInt) {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_delete_session(
                uniffiHandle,
                FfiConverterString.lower(`uid`),FfiConverterUInt.lower(`index`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_void(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_void(future, continuation) },
    ...
    override suspend fun `dismissAlarm`(`taskUid`: kotlin.String, `alarmUid`: kotlin.String) {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_dismiss_alarm(
                uniffiHandle,
                FfiConverterString.lower(`taskUid`),FfiConverterString.lower(`alarmUid`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_void(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_void(future, continuation) },
    ...
    override suspend fun `getRandomTaskUid`(`filterTags`: List<kotlin.String>, `filterLocations`: List<kotlin.String>, `searchQuery`: kotlin.String) : kotlin.String? {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_get_random_task_uid(
                uniffiHandle,
                FfiConverterSequenceString.lower(`filterTags`),FfiConverterSequenceString.lower(`filterLocations`),FfiConverterString.lower(`searchQuery`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_rust_buffer(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_rust_buffer(future, continuation) },
    ...
    UniffiLib.uniffi_cfait_fn_method_cfaitmobile_import_local_ics(
        it,
        FfiConverterString.lower(`calendarHref`),FfiConverterString.lower(`icsContent`),_status)
}
    }
    )
    }
    ...
    UniffiLib.uniffi_cfait_fn_method_cfaitmobile_log_message(
        it,
        FfiConverterString.lower(`level`),FfiConverterString.lower(`tag`),FfiConverterString.lower(`message`),_status)
}
    }
    ...
    override suspend fun `migrateLocalTo`(`sourceHref`: kotlin.String, `targetHref`: kotlin.String) : kotlin.String {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_migrate_local_to(
                uniffiHandle,
                FfiConverterString.lower(`sourceHref`),FfiConverterString.lower(`targetHref`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_rust_buffer(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_rust_buffer(future, continuation) },
    ...
    UniffiLib.uniffi_cfait_fn_method_cfaitmobile_parse_smart_string(
        it,
        FfiConverterString.lower(`input`),FfiConverterBoolean.lower(`isSearch`),_status)
}
    }
    )
    }
    ...
    @Throws(MobileException::class)override fun `saveConfig`(`url`: kotlin.String, `user`: kotlin.String, `pass`: kotlin.String, `insecure`: kotlin.Boolean, `hideCompleted`: kotlin.Boolean, `disabledCalendars`: List<kotlin.String>, `sortCutoffMonths`: kotlin.UInt?, `sortStandardByPriority`: kotlin.Boolean, `urgentDays`: kotlin.UInt, `urgentPrio`: kotlin.UByte, `defaultPriority`: kotlin.UByte, `startGracePeriodDays`: kotlin.UInt, `autoReminders`: kotlin.Boolean, `defaultReminderTime`: kotlin.String, `snoozeShort`: kotlin.UInt, `createEventsForTasks`: kotlin.Boolean, `deleteEventsOnCompletion`: kotlin.Boolean, `autoRefreshInterval`: kotlin.UInt, `trashRetention`: kotlin.UInt, `maxDoneRoots`: kotlin.UInt, `maxDoneSubtasks`: kotlin.UInt, `showOngoingNotifications`: kotlin.Boolean, `showQuickFilter`: kotlin.Boolean, `quickFilterTerm`: kotlin.String, `quickFilterIcon`: kotlin.String)
        = 
    callWithHandle {
    uniffiRustCallWithError(MobileException) { _status ->
    UniffiLib.uniffi_cfait_fn_method_cfaitmobile_save_config(
        it,
        FfiConverterString.lower(`url`),FfiConverterString.lower(`user`),FfiConverterString.lower(`pass`),FfiConverterBoolean.lower(`insecure`),FfiConverterBoolean.lower(`hideCompleted`),FfiConverterSequenceString.lower(`disabledCalendars`),FfiConverterOptionalUInt.lower(`sortCutoffMonths`),FfiConverterBoolean.lower(`sortStandardByPriority`),FfiConverterUInt.lower(`urgentDays`),FfiConverterUByte.lower(`urgentPrio`),FfiConverterUByte.lower(`defaultPriority`),FfiConverterUInt.lower(`startGracePeriodDays`),FfiConverterBoolean.lower(`autoReminders`),FfiConverterString.lower(`defaultReminderTime`),FfiConverterUInt.lower(`snoozeShort`),FfiConverterBoolean.lower(`createEventsForTasks`),FfiConverterBoolean.lower(`deleteEventsOnCompletion`),FfiConverterUInt.lower(`autoRefreshInterval`),FfiConverterUInt.lower(`trashRetention`),FfiConverterUInt.lower(`maxDoneRoots`),FfiConverterUInt.lower(`maxDoneSubtasks`),FfiConverterBoolean.lower(`showOngoingNotifications`),FfiConverterBoolean.lower(`showQuickFilter`),FfiConverterString.lower(`quickFilterTerm`),FfiConverterString.lower(`quickFilterIcon`),_status)
}
    }
    ...
    override suspend fun `shouldKeepNotification`(`taskUid`: kotlin.String, `notifType`: kotlin.String, `alarmUid`: kotlin.String?) : kotlin.Boolean {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_should_keep_notification(
                uniffiHandle,
                FfiConverterString.lower(`taskUid`),FfiConverterString.lower(`notifType`),FfiConverterOptionalString.lower(`alarmUid`),
            )
        },
    ...
    override suspend fun `snoozeAlarm`(`taskUid`: kotlin.String, `alarmUid`: kotlin.String, `minutes`: kotlin.UInt) {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_snooze_alarm(
                uniffiHandle,
                FfiConverterString.lower(`taskUid`),FfiConverterString.lower(`alarmUid`),FfiConverterUInt.lower(`minutes`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_void(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_void(future, continuation) },
    ...
    override suspend fun `updateLocalCalendar`(`href`: kotlin.String, `name`: kotlin.String, `color`: kotlin.String?) {
        ...
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_update_local_calendar(
                uniffiHandle,
                FfiConverterString.lower(`href`),FfiConverterString.lower(`name`),FfiConverterOptionalString.lower(`color`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_void(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_void(future, continuation) },
...
public object FfiConverterTypeAppIntent : FfiConverterRustBuffer<AppIntent>{
    override fun read(buf: ByteBuffer): AppIntent {
        return when(buf.getInt()) {
            ...
            5 -> AppIntent.CancelTask(
                FfiConverterString.read(buf),
                )
            6 -> AppIntent.ChangePriority(
                FfiConverterString.read(buf),
                FfiConverterByte.read(buf),
                )
            7 -> AppIntent.StartTask(
                FfiConverterString.read(buf),
                )
            8 -> AppIntent.PauseTask(
                FfiConverterString.read(buf),
                )
            9 -> AppIntent.StopTask(
                FfiConverterString.read(buf),
                )
            10 -> AppIntent.MoveTask(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
            11 -> AppIntent.DuplicateTaskTree(
                FfiConverterString.read(buf),
                )
            12 -> AppIntent.RemoveParent(
                FfiConverterString.read(buf),
                )
            13 -> AppIntent.MakeChild(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
            14 -> AppIntent.AddDependency(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
            15 -> AppIntent.RemoveDependency(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
            16 -> AppIntent.AddRelatedTo(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
            17 -> AppIntent.RemoveRelatedTo(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
            18 -> AppIntent.SetSearchTerm(
                FfiConverterString.read(buf),
                )
            19 -> AppIntent.ToggleTagFilter(
                FfiConverterString.read(buf),
                )
            20 -> AppIntent.ToggleLocationFilter(
                FfiConverterString.read(buf),
                )
            21 -> AppIntent.ClearFilters
            22 -> AppIntent.ToggleMatchAllCategories
            23 -> AppIntent.SetSidebarCalendar(
                FfiConverterString.read(buf),
                )
            24 -> AppIntent.ClearTagFilters
            25 -> AppIntent.ClearLocationFilters
            26 -> AppIntent.ToggleTreeCollapse(
                FfiConverterString.read(buf),
                )
            27 -> AppIntent.ToggleDoneGroup(
                FfiConverterString.read(buf),
                )
    ...
    override fun allocationSize(value: AppIntent) = when(value) {
