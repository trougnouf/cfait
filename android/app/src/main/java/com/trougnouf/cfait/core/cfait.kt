...
external fun uniffi_cfait_fn_method_cfaitmobile_get_view_tasks(`ptr`: Long,`filterTags`: RustBuffer.ByValue,`filterLocations`: RustBuffer.ByValue,`searchQuery`: RustBuffer.ByValue,`expandedGroups`: RustBuffer.ByValue,`collapsedGroups`: RustBuffer.ByValue,`matchAllCategories`: Byte,
): Long
...
external fun uniffi_cfait_fn_method_cfaitmobile_save_config(`ptr`: Long,`url`: RustBuffer.ByValue,`user`: RustBuffer.ByValue,`pass`: RustBuffer.ByValue,`insecure`: Byte,`hideCompleted`: Byte,`disabledCalendars`: RustBuffer.ByValue,`sortCutoffMonths`: RustBuffer.ByValue,`urgentDays`: Int,`urgentPrio`: Byte,`defaultPriority`: Byte,`startGracePeriodDays`: Int,`autoReminders`: Byte,`defaultReminderTime`: RustBuffer.ByValue,`snoozeShort`: Int,`createEventsForTasks`: Byte,`deleteEventsOnCompletion`: Byte,`autoRefreshInterval`: Int,`trashRetention`: Int,`maxDoneRoots`: Int,`maxDoneSubtasks`: Int,`showOngoingNotifications`: Byte,uniffi_out_err: UniffiRustCallStatus, 
): Unit
...
public interface CfaitMobileInterface {
    ...
    suspend fun `getViewTasks`(`filterTags`: List<kotlin.String>, `filterLocations`: List<kotlin.String>, `searchQuery`: kotlin.String, `expandedGroups`: List<kotlin.String>, `collapsedGroups`: List<kotlin.String>, `matchAllCategories`: kotlin.Boolean): MobileViewData
...
open class CfaitMobile: Disposable, AutoCloseable, CfaitMobileInterface
{
    ...
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `getViewTasks`(`filterTags`: List<kotlin.String>, `filterLocations`: List<kotlin.String>, `searchQuery`: kotlin.String, `expandedGroups`: List<kotlin.String>, `collapsedGroups`: List<kotlin.String>, `matchAllCategories`: kotlin.Boolean) : MobileViewData {
        return uniffiRustCallAsync(
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_cfait_fn_method_cfaitmobile_get_view_tasks(
                uniffiHandle,
                FfiConverterSequenceString.lower(`filterTags`),FfiConverterSequenceString.lower(`filterLocations`),FfiConverterString.lower(`searchQuery`),FfiConverterSequenceString.lower(`expandedGroups`),FfiConverterSequenceString.lower(`collapsedGroups`),FfiConverterBoolean.lower(`matchAllCategories`),
            )
        },
        { future, callback, continuation -> UniffiLib.ffi_cfait_rust_future_poll_rust_buffer(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_cfait_rust_future_complete_rust_buffer(future, continuation) },
